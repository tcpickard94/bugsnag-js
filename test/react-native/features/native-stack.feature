...
Scenario: Handled JS error with native stacktrace
  ...
  And the payload field "events.0.exceptions.1.stacktrace.0.method" equals ".generateException"
  And the payload field "events.0.exceptions.1.stacktrace.2.method" equals ".runScenario"
  And the payload field "events.0.exceptions.1.stacktrace.1.method" equals ".run"

  # PLAT-5117 addresses float serialization
  And the payload field "events.0.exceptions.1.stacktrace.0.lineNumber" equals "1.0"
  And the payload field "events.0.exceptions.1.stacktrace.1.lineNumber" equals "1.0"
  And the payload field "events.0.exceptions.1.stacktrace.2.lineNumber" equals "2.0"
